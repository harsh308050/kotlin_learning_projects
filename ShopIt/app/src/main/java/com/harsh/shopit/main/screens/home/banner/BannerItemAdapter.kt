package com.harsh.shopit.main.screens.home.banner
...
class BannerItemAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BannerViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.customer_item_banner_card, parent, false)
    ...
    override fun onBindViewHolder(
        ...
        holder.bannerTag.backgroundTintList =
            ColorStateList.valueOf(currItem.tagColor)
