package com.harsh.shopit.main.screens.home.trendProd
...
class TrendProductsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): trendProductsViewHolder {
        val itemView =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.customer_item_trending_product, parent, false)
    ...
    override fun onBindViewHolder(
        ...
        holder.trendProductsBgCard.backgroundTintList =
            ColorStateList.valueOf(currItem.trendProductBgCardColor)
